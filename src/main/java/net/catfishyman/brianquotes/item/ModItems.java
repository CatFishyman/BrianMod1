...
public class ModItems {
    ...
    private static Item registerItem(String name, Item item) {
        return Registry.register(Registry.ITEM, new Identifier(BrianQuotes.MOD_ID, name), item);
    }

    public static void registerModItems() {
        BrianQuotes.LOGGER.debug("Registering Mod Items for " + BrianQuotes.MOD_ID);
    }
}
